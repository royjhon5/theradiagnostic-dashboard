...
interface ContextType {
  ...
  currentRow: globalGetDiscountData | null;
  setCurrentRow: React.Dispatch<
    React.SetStateAction<globalGetDiscountData | null>
  >;
}
...
export default function MainProvider({ children }: Props) {
  ...
  const [currentRow, setCurrentRow] = useState<globalGetDiscountData | null>(
    null
  );
