...
import useGetLaboratoryPackage from "./hooks/useGetLaboratoryPackage";
import { globalLabPackageSchema } from "./schema";

export default function AddNewLabPackage() {
  const { laboratoryPackage } = useGetLaboratoryPackage();
  const result = globalLabPackageSchema.parse(laboratoryPackage);
