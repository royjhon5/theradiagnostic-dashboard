...
interface Props {
  ...
  currentRow: globalLabPackageData;
}
      ...
      desc={
        <div className="space-y-4">
          <p className="mb-2">
            ...
            <span className="font-bold">{currentRow.packageName}</span>?
            <br />
            This action will permanently remove{" "}
            <span className="font-bold">{currentRow.packageName}</span> from the
