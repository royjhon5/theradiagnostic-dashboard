    ...
    return (
      <ol
        ...
        className={cn(
          ...
          "relative min-h-[320px] overflow-auto w-full py-8",
          className
        )}
        {...props}
      >
    ...
    const content = (
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          {showConnector && (
            <>
              <div className="h-2 w-2 rounded-full bg-primary mt-4" />
              <div className="h-6 w-0.5 border border-dashed mt-2" />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col gap-0 pl-2", className)}
    {...props}
  />
));
